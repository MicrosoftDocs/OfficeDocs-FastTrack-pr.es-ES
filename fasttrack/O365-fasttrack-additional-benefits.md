...
Los clientes que compren al menos 20.000 licencias para un inquilino de Exchange online pueden optar a los servicios adicionales del centro de FastTrack. Consulte [elegibilidad](eligibility.md) para obtener más información. 
...
Los especialistas de FastTrack tienen las siguientes responsabilidades durante la incorporación. Estos pueden ser adicionales o reemplazar las actividades definidas en [proceso y expectativas](process-and-expectations.md).
  
## <a name="general"></a>General

- Proporcionar asistencia remota para el desarrollo, la implementación y las actividades de configuración necesarias de la planeación correcta, como se detalla en [productos y capacidades](products-and-capabilities.md).
...
El usuario tiene las siguientes responsabilidades durante la incorporación. Además de las responsabilidades definidas en [proceso y expectativas](process-and-expectations.md). 
