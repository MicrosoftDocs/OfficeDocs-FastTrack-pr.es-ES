...
El Centro de FastTrack ofrece asistencia para los servicios siguientes:
...
- Office 365 para el gobierno de Estados Unidos F1\*\*
- Office 365 ProPlus
...
## <a name="eligible-enterprise-mobility--security-plans"></a>Planes elegibles para Enterprise Mobility + Security

|Plan    |Detalles de elegibilidad  |
|---------|---------|
...
|**Azure Active Directory Premium**     |  Elegible si se ha comprado como plan independiente o como parte de E3 o E5.       |
|**Azure Information Protection**    |  Disponible para P2, como parte de E5 o como plan independiente. Disponible para los servicios en la nube que cumplan los requisitos de las ventajas de FastTrack. Para los servicios en la nube P1, FastTrack comparte la guía de implementación automática.       |
...
Para obtener más información, vea [Ventajas del Centro de FastTrack para Windows 10](https://go.microsoft.com/fwlink/?linkid=2044661).

> [!NOTE]
> No existe un requisito mínimo de licencia para los proveedores independientes de software (ISV) comerciales que crean aplicaciones para Windows 10. Todas las solicitudes de aplicación deben tener como objetivo una versión de Windows 10 o de Office 365 ProPlus que se encuentre actualmente en la ventana de servicio estándar.
