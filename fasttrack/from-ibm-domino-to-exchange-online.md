...
- El Centro FastTrack configura el entorno de migración en Azure.
    
- El Centro FastTrack configura las herramientas de migración en las estaciones de trabajo de administración locales.
    
- El Centro FastTrack configura y muestra cómo usar la herramienta de importación automática.
    
- El Centro FastTrack realiza la validación de todos los componentes de la migración y efectúa migraciones de prueba.
...
- El centro FastTrack realiza migraciones piloto y de velocidad. 
    
- El centro FastTrack lleva a cabo eventos de migración y actividades de cuenta atrás.
    
- El Centro FastTrack proporciona asistencia posterior a la migración.
